...
| `max_queue_size` | `"0"` (unlimited) | Max pending items in the input and output queues. New inputs are rejected with a warning when either queue reaches this limit. |
